...
public class MessageImpl implements Message{
    ...
    public MessageImpl(){
        ...
        messages.put("noConnection","No connection with server");
        ...
        messages.put("registration", "Registration");
        messages.put("identification","Identification");
        messages.put("identOutput", "identification completed");
