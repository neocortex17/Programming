...
public class SpaceMarine implements Comparable <SpaceMarine>{
    ...
    public String toString() {
        ...
        formatter.format("%d,%s,%s,%s,%d,%s,%s,%s,\"%s\"",id, name, coordinates.toString(), creationDate.toString(),health,category.toString(),weaponType.toString(),meleeWeapon.toString(),ch);
